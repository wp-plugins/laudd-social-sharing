...
* __Reward Influencers__: Users can redeem their earned points for real, valuable rewards.
	
= How It Works =

* After you install and activate the plugin and register a new website, all your pages and posts automatically display the Laudd sharing toolbar. 
...
* Users get 10 points on sign up, and earn one point for every visit they generate through content they have shared using this toolbar. 
...
The Laudd Plugin instantly enables you to increase your social buzz and traffic by offering real, valuable rewards to users who bring social traffic to your website.
= How do I display the Laudd sharing toolbar on my posts? =
When you install and activate the Laudd plugin, you automatically get the Laudd sharing toolbar on all pages of your WordPress website.
= How much does it cost?
The plugin itself is free, and the Laudd Service also offers a free-trial. Once your free trial is over, you can sign up for plans starting at $6.99 per month, depending upon the number of Laudd Generated Visits to your website.
= How do my users share my pages using the Laudd sharing toolbar? =
Users simply click on the icon of the social network that they want to share your content on in order to initiate the sharing process. After sharing is completed, if the user is not already signed up with Laudd, the user is asked to sign up using any social network. The user is encouraged to sign up in order to earn privilege points, which enable the user to get rewards. If the user doesn't want to sign up, the user can simply share the content by clicking the link at the bottom of that dialog.
...
== Screenshots ==
1. The Laudd sharing toolbar for new users and logged-in users.
2. Laudd rewards examples
